...
export default function Navbar() {
    return (
        <nav className="bg-white px-8 py-4 shadow-sm flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
                <div className="flex items-center gap-6 text-sm font-medium text-gray-700">
                    ...
                    <Link to="/patient/payments" className="hover:text-primary transition-colors">Lịch sử thanh toán</Link>
                </div>
                <Link
                    to="/auth"
